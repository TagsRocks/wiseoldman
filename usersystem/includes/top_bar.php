    	...
    	<nav class="navbar user-info-navbar"  role="navigation"><!-- User Info, Notifications and Menu Bar -->
			...
			<?php if(partial_access('admin')): //following nav is for admin users only. ?>
				<ul class="dropdown-menu">
                	<li><a href="messages.php"><span class="glyphicon glyphicon-envelope"></span> <?php echo $language['messages']; ?> <span class="badge"><?php $message_obj->unread_count(); ?></span></a></li>
