    ...
    <div class="col-sm-3">
      <div class="dash-widget dash-counter" data-count=".num" data-from="0" data-to="99.9" data-suffix="%" data-duration="2">
          ...
          <div class="dash-label">
              ...
              <span><?php echo $language['total_users']; ?></span>
          </div>
      </div>
	</div>
    ...
    <div class="col-sm-3">
      <div class="dash-widget dash-counter" data-count=".num" data-from="0" data-to="99.9" data-suffix="%" data-duration="2">
          ...
          <div class="dash-label">
              ...
              <span><?php echo $language['active_users']; ?></span>
          </div>
      </div>
	</div>
    ...
    <div class="col-sm-3">
      <div class="dash-widget dash-counter" data-count=".num" data-from="0" data-to="99.9" data-suffix="%" data-duration="2">
          ...
          <div class="dash-label">
              ...
              <span><?php echo $language['deactivate_users']; ?></span>
          </div>
      </div>
	</div>
    ...
    <div class="col-sm-3">
      <div class="dash-widget dash-counter" data-count=".num" data-from="0" data-to="99.9" data-suffix="%" data-duration="2">
          ...
          <div class="dash-label">
              ...
              <span><?php echo $language['ban_users']; ?></span>
          </div>
      </div>
	</div>
    ...
    <div class="col-sm-3">
      <div class="dash-widget dash-counter" data-count=".num" data-from="0" data-to="99.9" data-suffix="%" data-duration="2">
          ...
          <div class="dash-label">
              ...
              <span><?php echo $language['suspend_users']; ?></span>
          </div>
      </div>
	</div>
