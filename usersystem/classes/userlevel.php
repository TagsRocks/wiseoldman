	...
	<div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<input type="submit" value="'.$language["send_message"].'" class="btn btn-primary" />
				...
				$content .= '<input type="submit" class="btn btn-default btn-sm" value="'.$language["edit"].'">';
				$content .= '</form>';
				$content .= '</td><td>';
				...
				$content .= '<input type="submit" class="btn btn-default btn-sm" value="'.$language["delete"].'">';
				$content .= '</form>';
				$content .= '</td>';
				$content .= '</tr>';
				unset($class);
