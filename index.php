    ...
    <body>
        ...
        <div class="pre-nav">
            ...
            if(isset($_SESSION['email'])) {
                ?>
                <a class="item">
                    <?=$_SESSION['email'];?> <div class="caret"></div>
                </a>
        ...
        if(isset($_GET['registration'])) {
            ...
            ?>
            <div class="alert alert-success response" role="alert">
                <div class="container">
                    <span class="glyphicon glyphicon-ok"></span> <b>You have succesfully registered for OSRS Quest Manager</b>
                </div>
            </div>
            <?php
            }
        if($_GET['registration'] == "fail") {
            ?>
            <div class="alert alert-danger response" role="alert">
                <div class="container">
                    <span class="glyphicon glyphicon-remove"></span> <b>Something went wrong with your registration. Please try again.</b>
                </div>
            </div>
            <?php
            }
        ...
        <div class="jumbotron osrs">
            ...
            <div class="container front-page">
                <h1 class="medieval banner-title"><b>OSRS Quest Manager</b> <small style="display: inline-block;">-&nbsp;Quest Your Best</small></h1>
                <p>
                ...
                <p>
                    ...
                    if(!isset($_SESSION['email'])) {
                        ...
                        <div class="row button-row">
                            ...
                            <div class="col-md-4 center-content">
                                <a class="btn btn-default btn-lg" href="table.php" role="button">
                                    Quest Table
                                </a>
                            </div>
                        </div>
